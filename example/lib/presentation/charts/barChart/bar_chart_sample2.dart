...
class BarChartSample2 extends StatefulWidget {
  ...
  final Color endBarColor = AppColors.contentColorGreen;
...
class BarChartSample2State extends State<BarChartSample2> {
  ...
  void customData() {
    final barGroup1 = makeGroupData(0, 10, 12, 17);
    final barGroup2 = makeGroupData(1, 16, 12, 10);
    final barGroup3 = makeGroupData(2, 18, 5, 4);
    final barGroup4 = makeGroupData(3, 20, 16, 6);
    final barGroup5 = makeGroupData(4, 17, 6, 9);
    final barGroup6 = makeGroupData(5, 19, 1.5, 19);
    final barGroup7 = makeGroupData(6, 10, 1.5, 3);
              ...
              child: BarChart(
                BarChartData(
                  ...
                  barTouchData: BarTouchData(
                    ...
                    touchCallback: (AFlTouchEvent event, response) {
