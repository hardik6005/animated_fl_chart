...
import 'package:animated_fl_chart/main_class/src/chart/base/axis_chart/axis_chart_painter.dart';
...
abstract class AxisChartData extends BaseChartData with EquatableMixin {
  ...
  final AFlGridData gridData;
  final AFlTitlesData titlesData;
...
class AFlTitlesData with EquatableMixin {
  ...
  /// Lerps a [AFlTitlesData] based on [t] value, check [Tween.lerp].
  static AFlTitlesData lerp(AFlTitlesData a, AFlTitlesData b, double t) {
    return AFlTitlesData(
      show: b.show,
  ...
  /// Copies current [AFlTitlesData] to a new [AFlTitlesData],
  /// and replaces provided values.
  AFlTitlesData copyWith({
    bool? show,
    AxisTitles? leftTitles,
    AxisTitles? topTitles,
    AxisTitles? rightTitles,
...
class AFlSpot with EquatableMixin {
  ...
  static const AFlSpot nullSpot = AFlSpot(double.nan, double.nan);

  /// Sets zero for x and y
  static const AFlSpot zero = AFlSpot(0, 0);
  ...
  /// Lerps a [AFlSpot] based on [t] value, check [Tween.lerp].
  static AFlSpot lerp(AFlSpot a, AFlSpot b, double t) {
    if (a == AFlSpot.nullSpot) {
      return b;
    }

    if (b == AFlSpot.nullSpot) {
      return a;
    }
...
class AFlGridData with EquatableMixin {
  ...
  /// it gives you a double value (in the y axis), and you should return a [AFlLine] that represents
  /// a horizontal line.
  ...
  /// it gives you a double value (in the x axis), and you should return a [AFlLine] that represents
  /// a horizontal line.
  ...
  /// Gives you a y value, and gets a [AFlLine] that represents specified line.
  ...
  /// Gives you a x value, and gets a [AFlLine] that represents specified line.
  ...
  /// Lerps a [AFlGridData] based on [t] value, check [Tween.lerp].
  static AFlGridData lerp(AFlGridData a, AFlGridData b, double t) {
    return AFlGridData(
      show: b.show,
  ...
  /// Copies current [AFlGridData] to a new [AFlGridData],
  /// and replaces provided values.
  AFlGridData copyWith({
    bool? show,
    bool? drawHorizontalLine,
...
/// you should pass a [AFlLine] that represents style of specified line.
typedef GetDrawingGridLine = AFlLine Function(double value);

/// Returns a grey line for all values.
AFlLine defaultGridLine(double value) {
  return AFlLine(
...
class AFlLine with EquatableMixin {
  ...
  /// Lerps a [AFlLine] based on [t] value, check [Tween.lerp].
  static AFlLine lerp(AFlLine a, AFlLine b, double t) {
    return AFlLine(
...
class HorizontalLineLabel extends AFlLineLabel with EquatableMixin {
...
class VerticalLineLabel extends AFlLineLabel with EquatableMixin {
