...
import 'package:animated_fl_chart/main_class/src/chart/base/base_chart/base_chart_data.dart';
import 'package:animated_fl_chart/main_class/src/chart/base/base_chart/fl_touch_event.dart';
...
abstract class RenderBaseChart<R extends BaseTouchResponse> extends RenderBox
  ...
  /// Invokes the [_touchCallback] to notify listeners of this [AFlTouchEvent]
  ///
  ...
  void _notifyTouchEvent(AFlTouchEvent event) {
    if (_touchCallback == null) {
      return;
    }
