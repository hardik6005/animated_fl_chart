...
/// The callback passed to get the color of a [AFlSpot]
///
/// The callback receives [AFlSpot], which is the target spot,
...
/// The callback passed to get the painter of a [AFlSpot]
///
/// The callback receives [AFlSpot], which is the target spot,
/// [LineChartBarData] is the chart's bar.
...
class FlDotData with EquatableMixin {
  ...
  /// Callback which is called to set the painter of the given [AFlSpot].
  /// The [AFlSpot] is provided as parameter to this callback
...
///
/// It gives you the checking [AFlSpot] and you should decide to
...
class LineTouchData extends FlTouchData<LineTouchResponse> with EquatableMixin {
  ...
  /// based on the provided [AFlTouchEvent] and [LineTouchResponse]
  ///
...
class LineBarSpot extends AFlSpot with EquatableMixin {
  ...
  /// [spotIndex] is the index this [AFlSpot], in the [LineChartBarData.spots] list.
  LineBarSpot(
    this.bar,
    this.barIndex,
    AFlSpot spot,
