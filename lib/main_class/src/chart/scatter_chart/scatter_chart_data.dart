...
import 'package:animated_fl_chart/main_class/src/chart/scatter_chart/scatter_chart_helper.dart';
...
class ScatterSpot extends AFlSpot with EquatableMixin {
...
class ScatterTouchData extends FlTouchData<ScatterTouchResponse>
  ...
  /// based on the provided [AFlTouchEvent] and [ScatterTouchResponse]
  ///
